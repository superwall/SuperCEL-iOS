...
fileprivate struct UniffiCallbackInterfaceHostContext {
    ...
    static var vtable: UniffiVTableCallbackInterfaceHostContext = UniffiVTableCallbackInterfaceHostContext(
        computedProperty: { (
            uniffiHandle: UInt64,
            name: RustBuffer,
...
fileprivate struct FfiConverterCallbackInterfaceHostContext {
